...
-- Assuming that subjective taste quality can be used to distinguish c  lusters of chemical attributes, there should be at most 7, more likely 5 clusters in our dataset.
...
## runKmeans
Use kmeans() function to calculate 3 cluster permutations: 7 (number of Quality levels represented in data) and the two most frequently occuring cluster recommendations.
```{r runKMeans}
paste(
